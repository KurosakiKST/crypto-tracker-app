...
import com.ryan.cryptotracker.crypto.data.mappers.toCoinPrice
import com.ryan.cryptotracker.crypto.data.networking.dto.CoinHistoryDto
    ...
    override suspend fun getCoinHistory(
        ...
        return safeCall <CoinHistoryDto> {
            httpClient.get(
                ...
                parameter("interval", "h6") // call for 6hour history
